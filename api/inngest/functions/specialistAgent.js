 ...
 */
export var specialistAgent = inngest.createFunction({
    id: 'specialist-agent',
    name: 'Information Specialist Agent',
    retries: 2,
}, { event: 'agent/specialist/start' }, function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
    var _c, workflowId, gatheredData, preferences, filteredRecommendations, error_1;
    var event = _b.event, step = _b.step;
    return __generator(this, function (_d) {
        switch (_d.label) {
            case 0:
                _c = event.data, workflowId = _c.workflowId, gatheredData = _c.gatheredData, preferences = _c.preferences;
                console.log('👨‍💼 [INNGEST] Specialist Agent: Starting recommendation filtering', {
                    workflowId: workflowId.substring(0, 15) + '...',
                    preferencesCount: (preferences === null || preferences === void 0 ? void 0 : preferences.length) || 0,
                });
                _d.label = 1;
            case 1:
                _d.trys.push([1, 4, , 5]);
                return [4 /*yield*/, step.run('filter-recommendations', function () { return __awaiter(void 0, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    ...
                                    return [4 /*yield*/, filterRecommendations(mockRecommendations, preferences || [])];
                                case 1: return [2 /*return*/, _a.sent()];
                            }
                        });
                    }); })];
            case 2:
                filteredRecommendations = _d.sent();
                // Send completion event
                return [4 /*yield*/, step.sendEvent('specialist-complete', {
