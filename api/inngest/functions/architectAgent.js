 ...
 */
export var architectAgent = inngest.createFunction({
    id: 'architect-agent',
    name: 'Itinerary Architect Agent',
    retries: 2,
}, { event: 'agent/architect/start' }, function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
    var _c, workflowId, formData, architecture, error_1;
    var event = _b.event, step = _b.step;
    return __generator(this, function (_d) {
        switch (_d.label) {
            case 0:
                _c = event.data, workflowId = _c.workflowId, formData = _c.formData;
            ...
            case 1:
                _d.trys.push([1, 4, , 5]);
                return [4 /*yield*/, step.run('generate-architecture', function () { return __awaiter(void 0, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, architectAgentImpl.generateArchitecture({
            ...
            case 2:
                architecture = _d.sent();
                // Send completion event
                return [4 /*yield*/, step.sendEvent('architect-complete', {
