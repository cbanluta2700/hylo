...
var WebInformationGathererAgent = /** @class */ (function () {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 1:
            ...
            console.log(
              '[Gatherer Agent] Gathering information for '
                .concat(input.destination, ' - workflow ')
                .concat(input.workflowId)
            );
          ...
          case 2:
            ...
            console.log(
              '[Gatherer Agent] Completed information gathering in '.concat(processingTime, 'ms')
            );
            return [
              2 /*return*/,
              __assign(
                __assign(__assign({}, gatheredInfo), { processingTime: processingTime }),
          ...
          case 3:
            error_1 = _b.sent();
            console.error(
              '[Gatherer Agent] Failed for workflow '.concat(input.workflowId, ':'),
              error_1
            );
            throw new Error(
              'Information gathering failed: '.concat(
  ...
  WebInformationGathererAgent.prototype.buildUserPrompt = function (input) {
    return 'Gather comprehensive travel information for this destination:\n\nDESTINATION: '
      .concat(input.destination, '\n\nTRAVEL REQUIREMENTS:\n- Duration: ')
      .concat(input.itineraryStructure.totalDays, ' days\n- Budget: ')
      .concat(input.budget.total, ' ')
      .concat(input.budget.currency, ' total\n- Accommodation Budget: ')
      .concat(input.budget.breakdown.accommodation, ' ')
      .concat(input.budget.currency, '\n- Food Budget: ')
      .concat(input.budget.breakdown.food, ' ')
      .concat(input.budget.currency, '\n- Activities Budget: ')
      .concat(input.budget.breakdown.activities, ' ')
      .concat(input.budget.currency, '\n\nTRAVELER PREFERENCES:\n- Travel Pace: ')
      .concat(input.travelStyle.pace, '\n- Accommodation Type: ')
      .concat(input.travelStyle.accommodationType, '\n- Dining Preferences: ')
      .concat(input.travelStyle.diningPreferences, '\n- Activity Level: ')
      .concat(input.travelStyle.activityLevel, '\n- Primary Interests: ')
      .concat(input.interests.join(', '), '\n\nTRAVEL PHASES:\n')
      .concat(
        input.itineraryStructure.travelPhases
          .map(function (phase, i) {
            ...
            return '- Phase '
              ...
              .concat(phase.focus, ' (')
              .concat(
                ((_a = phase.days) === null || _a === void 0 ? void 0 : _a.length) || 1,
                ' day(s))'
              );
          })
          .join('\n'),
  ...
  WebInformationGathererAgent.prototype.createFallbackInformation = function (input) {
    return {
      destinationInfo: {
        overview: ''.concat(
          input.destination,
          ' is a popular travel destination offering diverse experiences.'
        ),
      ...
      accommodations: [
        {
          name: ''
            .concat(input.travelStyle.accommodationType, ' accommodation in ')
            .concat(input.destination),
      ...
      activities: input.interests.map(function (interest) {
        return {
